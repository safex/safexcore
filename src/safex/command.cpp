...
namespace safex
{
  ...
  edit_account_result* edit_account::execute(const cryptonote::BlockchainDB &blokchain, const cryptonote::txin_to_script &txin) {
    ...
    close_offer_result* close_offer::execute(const cryptonote::BlockchainDB &blokchain, const cryptonote::txin_to_script &txin) {
        execution_status result = validate(blokchain, txin);
    ...
    execution_status close_offer::validate(const cryptonote::BlockchainDB &blokchain, const cryptonote::txin_to_script &txin) {
